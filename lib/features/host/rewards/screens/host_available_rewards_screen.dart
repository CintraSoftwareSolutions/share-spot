...
class HostAvailableRewardsScreen extends StatelessWidget {
  const HostAvailableRewardsScreen({super.key});
  ...
  static const _rewards = [
    ...
    (AppImages.bellaItallino, '20% Off on All Pastries', 'Sweet Treats', 300),
    (
      AppImages.tropicalParadise,
      'Buy Two Get One Free Pizza',
      'Pizza Palace',
      600,
    ),
  ];
