...
class HostChatDetailScreen extends StatelessWidget {
  const HostChatDetailScreen({super.key, this.conversation});
  ...
  Future<void> _showRating(BuildContext context) {
    return showModalBottomSheet<void>(
      ...
      builder: (_) => ParkingRatingSheet(
        onSubmit: context.read<HostMessagesProvider>().submitRating,
      ),
    );
  }
  ...
  Future<void> _confirmArrival(
    ...
    context.read<HostMessagesProvider>().completeExchange(
  ...
  Widget build(BuildContext context) {
    ...
    final exchangeCompleted = context.select<HostMessagesProvider, bool>(
